...
These results are slightly different because the installed versions of packages
generally don't include `README` files, and so the text being matched is
different from the downloaded version which includes additional information
contained in `README`
...
which provides detailed explanations of the matching algorithm implemented in
the package.
- [_Data caching and
updating_](https://docs.ropensci.org/pkgmatch/articles/C_data-caching-and-updating.html)

...
either to a text description, or to any given package. Can find matching
...
can be automatically opened, either by passing `browse = TRUE`, or by storing
the return value of [the `pkgmatch_similar_pkgs()`
function](https://docs.ropensci.org/pkgmatch/reference/pkgmatch_similar_pkgs.html)
...
`httptest2` package for testing output of `httr2`.

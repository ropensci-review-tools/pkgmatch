...
`pkgmatch` accesses LMs through a local [ollama server](https://ollama.com), as
described in the [ollama installation vignette](https://docs.ropensci.org/pkgmatch/articles/B_ollama.html).
...
cosine similarity for each package, along with a corresponding rank, where

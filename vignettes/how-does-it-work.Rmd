...
- Final ranking:
    ...
    with fixed `k = 60`, as recommended in original paper.
...
Final, the best matching outputs from the various combinations of input chunks
and algorithms are combined using the [*Reciprocal Rank Fusion* (RRF) algorithm
...
sensitivity of results to variations in this value.

Where inputs are entire packages, final rankings are generated separately for
code and text.

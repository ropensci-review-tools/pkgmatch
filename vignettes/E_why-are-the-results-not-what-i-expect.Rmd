...
context windows of 8096 tokens, which is often not enough to enter the entire
code or text of a package, which includes full text of all help files and
vignettes. The embeddings generated for the two corpora used here, of rOpenSci
and CRAN, are generated from five "chunks" or randomly-permuted versions of
pacakge texts, to ensure that full texts are represented in resultant
embeddings, and to reduce the influence of specific text ordering.
...
This approach is neverthless the only feasible approach within this package,
